...
<div class="figure">
<img src="images/PatientLevelPrediction/Figure1.png" alt="The prediction problem"  />
...
<div class="figure">
<img src="images/PatientLevelPrediction/studydesign.png" alt="Design choices"  />
<p class="caption">(\#fig:studydesign)Design choices</p>
</div>

<div class="figure">
<img src="images/PatientLevelPrediction/problems.png" alt="Examples of prediction problems"  />
...
<div class="figure">
<img src="images/PatientLevelPrediction/atlas_t.png" alt="Target Cohort Atrial Fibrillation"  />
<p class="caption">(\#fig:atlas_t)Target Cohort Atrial Fibrillation</p>
</div>
...
<div class="figure">
<img src="images/PatientLevelPrediction/atlas_o.png" alt="Outcome Cohort Stroke"  />
<p class="caption">(\#fig:atlas_o)Outcome Cohort Stroke</p>
</div>
...
![](images/PatientLevelPrediction/atlasplp1.png)<!-- -->

2. Specify one or more analysis settings

![](images/PatientLevelPrediction/atlasplp2.png)<!-- -->

\newpage
3.  Specify the trainings settigns.

![](images/PatientLevelPrediction/atlasplp3.png)<!-- -->
  
4.  Specify the execution settings.

![](images/PatientLevelPrediction/atlasplp4.png)<!-- -->
...
![](images/PatientLevelPrediction/atlasdownload1.png)<!-- -->
...
![](images/PatientLevelPrediction/atlasdownload2.png)<!-- -->
...
![](images/PatientLevelPrediction/shinysummary.png)<!-- -->
...
![](images/PatientLevelPrediction/shinyroc.png)<!-- -->
...
![](images/PatientLevelPrediction/sparseROC.png)<!-- -->
...
![](images/PatientLevelPrediction/sparseCalibration.png)<!-- -->
...
![](images/PatientLevelPrediction/smoothCalibration.jpeg)<!-- -->
...
![](images/PatientLevelPrediction/preferencePDF.png)<!-- -->
...
![](images/PatientLevelPrediction/predictionDistribution.png)<!-- -->
...
![](images/PatientLevelPrediction/generalizability.png)<!-- -->
...
![](images/PatientLevelPrediction/variableScatterplot.png)<!-- -->
...
![](images/PatientLevelPrediction/precisionRecall.png)<!-- -->
...
![](images/PatientLevelPrediction/demographicSummary.png)<!-- -->
...
![](images/PatientLevelPrediction/popdef4.png)<!-- -->

\newpage

5. Include all persons in target cohort exclude persons with prior outcomes.

![](images/PatientLevelPrediction/popdef5.png)<!-- -->

6. Include all persons in target cohort.

![](images/PatientLevelPrediction/popdef6.png)<!-- -->
