...
```{r ps, fig.cap='Preference score distribution. The preference score is a transformation of the propensity score that adjusts for differences in the sizes of the two treatment groups. A higher overlap indicates subjects in the two groups were more similar in terms of their predicted probability of receiving one treatment over the other.',echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics("images/MethodValidity/ps.png")
```
...
```{r balanceScatterplot, fig.cap='Covariate balance before and after matching. Each dot represents the standardizes difference of means for a single covariate before and after matching on the propensity score. ',echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/MethodValidity/balanceScatterplot.png")
```
