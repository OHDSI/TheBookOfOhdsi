...
```{r figure1, fig.cap='The prediction problem',echo=FALSE}
...
```{r studydesign, fig.cap='Design choices',echo=FALSE}
knitr::include_graphics("images/PatientLevelPrediction/studydesign.png")
```

```{r problems, fig.cap='Examples of prediction problems',echo=FALSE}
...
```{r atlas_t, fig.cap='Target Cohort Atrial Fibrillation',echo=FALSE}
...
```{r atlas_o, fig.cap='Outcome Cohort Stroke',echo=FALSE}
