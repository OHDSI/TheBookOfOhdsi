...
```{r figure_theory1, fig.cap='Observational data.',echo=FALSE, out.width='100%'}
...
```{r figure_theory2, fig.cap='Create laelled data from observational data.',echo=FALSE, out.width='100%'}
...
```{r figure_theory3, fig.cap='Create laelled data from observational data.',echo=FALSE, out.width='100%'}
...
```{r figure_theory5, fig.cap='Overfitting issues.',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/theory/noise.png")
```

The issue here is that these boundaries may be fit too closely to the labelled data used to learn them and may not work for new data.  For example, noise causing incorrectly positioned data points can cause issues.  This is shown in Figure Y where the ...

Therefore, you want a model that appers to partition the labelled data well but is also as simple as possible.  Techniques such as regularization aim to maximise model performance on the labelled data while minimising complexity. 
...
```{r figure_theory_val, fig.cap='Types of internal valdiation.',echo=FALSE, out.width='100%'}
...
```{r figure_theory_extval, fig.cap='Visulisation of external validation.',echo=FALSE, out.width='100%'}
...
```{r figure_theory_tab, fig.cap='Example performance table.',echo=FALSE, out.width='100%'}
