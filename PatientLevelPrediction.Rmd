...
```{r tabletheorytab, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
...
```{r plpPrecisionRecall, fig.cap='Positive predictive value-sensitivy aka Precision-recall plot.',echo=FALSE, out.width='80%', fig.align='center'}
...
```{r specification1, fig.cap='The atlas prediction specification part 1.',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlasImplementation/specification_p1.png")
```
...
```{r specification2, fig.cap='The atlas prediction specification part 2',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlasImplementation/specification_p2.png")
```
...
```{r covariate1, fig.cap='The covariate settings view part 1',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlasImplementation/covariates_p1.png")
```

```{r covariate2, fig.cap='The covariate settings view part 2',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlasImplementation/covariates_p2.png")
```
...
```{r insuf, fig.cap='Reviewing when insufficient design',echo=FALSE, out.width='100%'}
...
```{r utilities, fig.cap='The utilities tab reviewing valid study',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlasImplementation/utilities_p1.png")
```
...
```{r export, fig.cap='Exporting a study design',echo=FALSE, out.width='100%'}
...
```{r shinySum, fig.cap='The starting summary page of the viewPlp() shiny app',echo=FALSE, out.width='80%', fig.align='center'}
  knitr::include_graphics("images/PatientLevelPrediction/shiny/singleShiny/singleShinySummary.png")
```

```{r shinyROC, fig.cap='The ROC plot for predicting AMI within a year in new users of ACE inhibitors',echo=FALSE, out.width='80%', fig.align='center'}
...
```{r shinyCal, fig.cap='The calibration of the model',echo=FALSE, out.width='80%', fig.align='center'}
  knitr::include_graphics("images/PatientLevelPrediction/shiny/singleShiny/singleShinyCal.png")
```

```{r shinyDemo, fig.cap='The demographic calibration of the model',echo=FALSE, out.width='80%', fig.align='center'}
...
```{r shinyAtt, fig.cap='The attrition plot for the prediction problem',echo=FALSE, out.width='80%', fig.align='center'}
...
```{r shinyResults, fig.cap='The directory where the atlas models and results were saved',echo=FALSE, out.width='80%', fig.align='center'}
  knitr::include_graphics("images/PatientLevelPrediction/shiny/shinyResults.png")
```
...
```{r shinyModel, fig.cap='To view the model settings used when developing the model.',echo=FALSE, out.width='80%', fig.align='center'}
