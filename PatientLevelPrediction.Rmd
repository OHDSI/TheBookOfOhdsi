...
```{r studydesign, fig.cap='Design choices',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/studydesign.png")
```

```{r problems, fig.cap='Examples of prediction problems',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/problems.png")
```
...
```{r atlast, fig.cap='Target Cohort Atrial Fibrillation',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlast.png")
```
...
```{r atlaso, fig.cap='Outcome Cohort Stroke',echo=FALSE, out.width='100%'}
knitr::include_graphics("images/PatientLevelPrediction/atlaso.png")
```
...
```{r atlasplp1, echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/atlasplp1.png")
```

2. Specify one or more analysis settings

```{r atlasplp2, echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/atlasplp2.png")
```

\newpage
3.  Specify the trainings settigns.

```{r atlasplp3, echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/atlasplp3.png")
```

4.  Specify the execution settings.

```{r atlasplp4, echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/atlasplp4.png")
```
...
```{r atlasdownload1, echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/atlasdownload1.png")
```
...
```{r atlasdownload2, echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/atlasdownload2.png")
```
...
```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/shinyroc.png")
```
...
```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/popdef1.png")
```

2. Require minumum time-at-risk for target cohort, except for persons with outcomes during time-at-risk.

```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/popdef2.png")
```
...
```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/popdef3.png")
```
...
```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/popdef4.png")
```
...
```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/popdef5.png")
```

6. Include all persons in target cohort.

```{r echo=FALSE, out.width='100%'}
  knitr::include_graphics("images/PatientLevelPrediction/popdef6.png")
```
