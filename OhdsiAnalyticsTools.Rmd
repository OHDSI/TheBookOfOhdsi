...
```{r awsDiagram, fig.cap='The Amazon Web Services architecure for OHDSI-in-a-Box and OHDSIonAWS.',echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("images/OhdsiAnalyticsTools/awsDiagram.png")
```
