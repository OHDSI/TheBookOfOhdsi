...
### OHDSI Forum
The [OHDSI Forum](http://forum.ohdsi.org) is an online discussion site where OHDSI Community Collaborators can hold conversations in the form of posted messages. 
...
Learn more about the power of the OHDSI Community. Explore past symposiums, face-to-face meetings and watch OHDSI tutorials by visiting the [OHDSI Past Events](https://www.ohdsi.org/past-events/). Past Events is updated regularly to archive community events. Check back regularly for new resources.
...
|CDM & Vocabulary|Christian Reich, Rimma Beleketer, Patrick Ryan, Clair Blacketer|- To continue to develop the OMOP Common Data Model for the purpose of systematic, standardized and large-scale analytics applied to clinical patient data.
...
|Maternal & Child Health|Miriam Sturkenboom, Jamie Weaver| The OHDSI maternal child health group aims to specifically address: 
...
- Methods and designs for maternal drug/vaccine exposure and pediatric drug/vaccine exposure outcome studies (safety & effectiveness)|Open to all with an interest in maternal and child health|
...
**I am a clinical researcher looking to start a study.** If you are a clinical researcher interesting in using the OHDSI Research Network to answer a specific question -- maybe even publish a paper -- you're in the right place. You can start by posting your idea to the [OHDSI Researchers Topic](https://forums.ohdsi.org/c/researchers) on the OHDSI Forum. This will help you connect with researchers of similar interest. OHDSI loves to publish and has many resources available to expedite turning your research question into an analysis and a paper. You can find more information in the [Population-Level Estimation] and [Patient Level Prediction] Chapters.
