...
```{r datajourney, fig.cap='The journey from data to evidence', echo=FALSE, out.width='75%', fig.align='center'}
knitr::include_graphics("images/Collaborators/datajourney.png")
```
...
```{r collaboratormap, fig.cap='Map of OHDSI collaborators', echo=FALSE, out.width='75%', fig.align='center'}
knitr::include_graphics("images/Collaborators/collaboratormap.png")
```
