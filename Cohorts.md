...
\begin{figure}
\includegraphics[width=1\linewidth]{images/Cohorts/cohort-build} \caption{Cohort Creation}(\#fig:figure1)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/Cohorts/cohort-TAR} \caption{Time-at-Risk Construction}(\#fig:figure2)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/Cohorts/cohort-PPV} \caption{Algorithm Evaluation}(\#fig:figure3)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/Cohorts/cohort-legos} \caption{Building Blocks of Cohorts}(\#fig:figure4)
\end{figure}
