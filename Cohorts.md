...
The chapter serves to explain what is meant by creating and sharing cohort definitions, the methods for developing cohorts, and how to build your own cohorts using ATLAS (see Chapter \@ref(OhdsiAnalyticsTools)).
...
{\centering \includegraphics[width=0.9\linewidth]{images/Cohorts/cohort-legos} 
