...
```{r arachne, fig.cap='The ARACHNE Network Study Process.',echo=FALSE, out.width='100%'}
...
```{r arachneNon, fig.cap='The ARACHNE Network of Networks.',echo=FALSE, out.width='100%'}
