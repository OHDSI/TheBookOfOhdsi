...
```{r conceptAncestor, fig.cap='Hierarchy of the Condition “Atrial fibrillation”. First degree ancestry is defined through “Is a” and “Subsumes” Relationships, while those and all higher degree relations are inferred and stored in CONCEPT_ANCESTOR. Each Concept is also its own descendant with both Levels of Separation = 0.',echo=FALSE, out.width='100%', fig.align='center'}
