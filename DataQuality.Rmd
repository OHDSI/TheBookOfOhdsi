...
Two types of DQ checks can be distinguished
...
Since 2015, a component of the OHDSI Achilles tool called Heel was used to check data quality. 
...
(overview of existing Heel rules)
Each check has a rule_id.
