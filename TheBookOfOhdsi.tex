...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.nfyexlj0children ;"
\end{verbatim}
...
\hypertarget{rule-based-cohort-dedinirion}{%
\subsection{Rule-based cohort dedinirion}\label{rule-based-cohort-dedinirion}}
...
\item
  \textbf{Domain-specific attribute}: Additional attributes related to the clinical entity of interest (Ex: DRUG\_EXPOSURE: Days supply; MEASUREMENT: value\_as\_number, high\_range)
\item
...
\hypertarget{implenting-a-cohort-using-atlas}{%
\subsection{Implenting a Cohort using ATLAS}\label{implenting-a-cohort-using-atlas}}
