...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.kl9bzctychildren ;"
\end{verbatim}
...
window in Figure \ref{fig:comparisons} should appear. Then click on
...
\includegraphics{images/PopulationLevelEstimation/image11.png} button.
These will be listed in a table with ID and Name columns displayed. Many
entries can be displayed in this table.
