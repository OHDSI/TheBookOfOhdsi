...
\subsection{Support for multiple
analyses}\label{support-for-multiple-analyses}

\subsection{Big data support}\label{BigDataSupport}
...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.wz8zidp6children ;"
\end{verbatim}
...
we use the minumum age where \(order\_nr < .50 * n\). The minimum and
...
We first create ``tar'', CTE that contains all exposures with the
