...
\item
  Cross-links, indications (we don't know what disease a drug is meant
  to treat, person by person)
...
\item
  Reference is not in the data, look in the vocabulary for reference
  information
\item
  Design principles, adherence Standardized Clinical Data Tables - do
  not restate the wiki here, they should be separate
\item
  Person Table
  ...
  \item
    Conventions
  \item
    How would Lauren look? ETC\ldots{}.similar section for each CDM
    table
  \end{itemize}
\end{itemize}
...
functions for cardiovascular disease \citet{wilson1998}, or the models
