...
Since 2015, a component of the OHDSI Achilles tool called Heel was used
to check data quality.\citep{huser_methods_2018}

\subsection{Precomputed Analysis}\label{precomputed-analysis}
...
(overview of existing Heel rules) Each check has a rule\_id.
