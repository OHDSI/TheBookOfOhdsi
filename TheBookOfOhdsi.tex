...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.bsajqhj9children ;"
\end{verbatim}
...
One of the concerns that is often raised around observational studies and the use of ``real world data'' is the topic of data quality \citep[\citet{hersh2013caveats}, \citet{sherman2016real}]{botsis2010secondary}. Commonly noted is that data used in observational research were not originally gathered for research purposes and thus may suffer from incomplete or inaccurate data capture as well inherent biases. These concerns have given rise to a growing body of research around how to measure, characterize, and ideally improve data quality \citep[\citet{liaw2013towards}, \citet{weiskopf2013methods}]{kahn2012pragmatic}. The OHDSI community is a strong advocate of such research and community members have led and participated in many studies looking at data quality in the OMOP CDM and the OHDSI network \citep[\citet{kahn2015transparent}, \citet{callahan2017comparison}, \citet{yoon2016conversion}]{huser2016multisite}.
...
To compute the number of people with at least one prescription of celecoxib, we need to query the DRUG\_EXPOSURE table. To find all drugs containing the ingredient celecoxib, we join to the CONCEPT\_ANCESTOR and CONCEPT tables:
