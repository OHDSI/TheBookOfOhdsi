...
\usepackage[paperheight=10in,paperwidth=7in,margin=1in,inner=0.75in,outer=0.5in,top=0.7in,bottom=0.7in]{geometry}
\usepackage{hyperref}
...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.ml6h4jbjchildren ;"
\end{verbatim}
