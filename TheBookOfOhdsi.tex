...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.pgietl7hchildren ;"
\end{verbatim}
...
\NormalTok{  connectionDetails, }
  ...
  \DataTypeTok{outputFolder =} \StringTok{"C:/dataQualityExample"}\NormalTok{) }\CommentTok{#or your folder of choice}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{DataQualityDashboard}\OperatorTok{::}\KeywordTok{viewDqDashboard}\NormalTok{(}
  \StringTok{"C:/dataQualityExample/Eunomia/results_Eunomia.json"}\NormalTok{) }\CommentTok{#or your folder of choice}
\end{Highlighting}
\end{Shaded}
