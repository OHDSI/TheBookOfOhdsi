...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.j0f0k2phchildren ;"
\end{verbatim}
...
We can configure this by selecting the Event will persist \emph{until the end of a drug exposure}. We then will add our persistence window and append the concept set for ACE inhibitors. Now check your logic against Figure \ref{fig:ATLASchortexit}.
