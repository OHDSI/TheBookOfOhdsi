...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.odetzf2zchildren ;"
\end{verbatim}
...
\KeywordTok{renderTranslateExecuteSql}\NormalTok{(conn, sql, }\DataTypeTok{cdm_db_schema =}\NormalTok{ cdmDbSchema,}\DataTypeTok{max_gap =} \DecValTok{30}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
