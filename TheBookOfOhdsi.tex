...
Disease natural historyIncidence ratePrevalenceTreatment utilizationTreatment pathwayQuality improvement\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.45\columnwidth}\raggedright
Population-level effect estimation\strut
\end{minipage} & \begin{minipage}[t]{0.49\columnwidth}\raggedright
Safety surveillanceEffect estimationComparative effectiveness\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.45\columnwidth}\raggedright
Patient-level prediction\strut
\end{minipage} & \begin{minipage}[t]{0.49\columnwidth}\raggedright
Precision MedicineDisease onset and progressionTreatment choiceDisease interceptionTreatment responseTreatment safetyTreatment adherence\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
What kinds of question are you asking?\strut
\end{minipage} & \begin{minipage}[b]{0.33\columnwidth}\raggedright
If the desired output is:\strut
\end{minipage} & \begin{minipage}[b]{0.26\columnwidth}\raggedright
\ldots then you're probably asking for:\strut
\end{minipage}\tabularnewline
\midrule
\endhead
\bottomrule
...
What are the for patients\ldots.'
...
What are the risk factors of\ldots? (if identifying a specific risk factor, may be estimation, not prediction)
...
\textbar Clinical characterization\textbar{}
\textbar{}
...
\textbar Population-level effect estimation\textbar{}
\textbar{}
...
\textbar Patient-level prediction\textbar{}
...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.xlv8xa2echildren ;"
\end{verbatim}
