...
\hypertarget{frame-research-question-in-ohdsi-speak}{%
\section{Frame research question in OHDSI-speak}\label{frame-research-question-in-ohdsi-speak}}
...
\section{Example of a Study in OHDSI-speak}\label{example-of-a-study-in-ohdsi-speak}}
...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.z1o25k2wchildren ;"
\end{verbatim}
...
To visualize the importance of these criteria, think of how this information comes together in a person's timeline (Figure . The OBSERVATION\_PERIOD table creates the window for which we see the person in the data.\index{cohort!criteria}
