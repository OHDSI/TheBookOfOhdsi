...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.uw9955m6children ;"
\end{verbatim}
...
\caption{\label{tab:cmChoices}Main design choices in a comparative cohort design.}
\centering
...
\index{covariate balance} \textbackslash index\{balance\textbar see \{covariate balance\}
