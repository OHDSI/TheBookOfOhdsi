...
studies (refs), as well as methodological studies (refs). Great care is
taken to ensure the validity of the Methods Library, as described in
Chapter \ref{SoftwareValidity}.
...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.zyy7p1uqchildren ;"
\end{verbatim}
