...
\usepackage[paperheight=10in,paperwidth=7in,margin=1in,inner=1in,outer=0.65in,top=1.1in,bottom=0.65in]{geometry}
\usepackage{hyperref}
...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.k7yb92wachildren ;"
\end{verbatim}
