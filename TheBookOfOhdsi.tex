...
\begin{verbatim}
## [1] "SELECT * FROM temp_schema.fm5i3teichildren ;"
\end{verbatim}
...
\NormalTok{aceInhibitors <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1335471}\NormalTok{,}\DecValTok{1340128}\NormalTok{,}\DecValTok{1341927}\NormalTok{,}\DecValTok{1363749}\NormalTok{,}\DecValTok{1308216}\NormalTok{,}\DecValTok{1310756}\NormalTok{,}\DecValTok{1373225}\NormalTok{,}\DecValTok{1331235}\NormalTok{,}
                   \DecValTok{1334456}\NormalTok{,}\DecValTok{1342439}\NormalTok{)}
\NormalTok{thiazides <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1395058}\NormalTok{,}\DecValTok{974166}\NormalTok{,}\DecValTok{978555}\NormalTok{,}\DecValTok{907013}\NormalTok{)}

\CommentTok{# Define which types of covariates must be constructed:}
\NormalTok{covSettings <-}\StringTok{ }\KeywordTok{createDefaultCovariateSettings}\NormalTok{(}\DataTypeTok{excludedCovariateConceptIds =} \KeywordTok{c}\NormalTok{(aceInhibitors, }
\NormalTok{                                                                              thiazides),}
...
\chapter{Propensity scores}\label{propensity-scores}
...
\section{Fitting a propensity model}\label{fitting-a-propensity-model}
...
\section{Using the propensity score}\label{using-the-propensity-score}
...
\section{Inspecting select population
...
\section{Inserting the population cohort in the
...
\chapter{Follow-up and power}\label{follow-up-and-power}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Generate some output}
\end{Highlighting}
\end{Shaded}

\chapter{Outcome models}\label{outcome-models}

The outcome model is a model describing which variables are associated
with the outcome.

\section{Fitting a simple outcome
