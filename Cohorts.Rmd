...
```{r cohortBuild, fig.cap='Cohort Creation',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r cohortTar, fig.cap='Time-at-Risk Construction',echo=FALSE, out.width='90%', fig.align='center'}
...
We can configure this by selecting the Event will persist *until the end of a drug exposure*. We then will add our persistence window and append the concept set for ACE inhibitors. Now check your logic against Figure \@ref(fig:ATLAS-cohortexit).
...
- An **OHDSI cohort** is set of persons who satisfy one or more inclusion criteria for a duration of time.
