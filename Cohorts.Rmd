...
**OHDSI Cohort:** set of persons who satisfy one or more inclusion criteria for a duration of time
**OHDSI Cohort Definition:** the description of inclusion criteria used for identifying a particular cohort
```
...
```{r cohortPpv, fig.cap='Algorithm Evaluation', echo=FALSE, out.width='90%', fig.align='center'}
...
```{r cohortLegos, fig.cap='Building Blocks of Cohorts',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r ATLAScohort, fig.cap='Navigating to ATLAS Cohort Definition module',echo=FALSE, out.width='50%', fig.align='center'}
...
```{r ATLASimportaconcept, fig.cap='Specifying a Concept Set - Step 1',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r ATLAS-IC1, fig.cap='Additional Inclusion Criteria #1',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r ATLAS-IC2, fig.cap='Additional Inclusion Criteria #2',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r ATLAS-IC3, fig.cap='Additional Inclusion Criteria #3',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r ATLAS-cohortexit, fig.cap='Cohort Exit Criteria',echo=FALSE, out.width='90%', fig.align='center'}
