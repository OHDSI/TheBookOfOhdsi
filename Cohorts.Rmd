...
```{r CohortPractice, fig.cap='Logical Diagram of Intended Cohort',echo=FALSE, out.width='100%'}
...
```{r ATLAScohort, fig.cap='Navigating to ATLAS Cohort Definition module',echo=FALSE}
knitr::include_graphics("images/Cohorts/ATLAS-cohort.png")
```

When the module loads, click on the blue botton on the right that says 'New Cohort':

```{r ATLASnewcohort, fig.cap='Navigating to ATLAS New Cohort button',echo=FALSE}
...
```{r ATLASdefineacohort, fig.cap='New Cohort Definition',echo=FALSE}
...
```{r ATLASinitialevent, fig.cap='Adding an Initial Event',echo=FALSE}
...
```{r ATLASdrugexposure, fig.cap='Building a Drug Exposure Criteria',echo=FALSE}
...
```{r ATLASimportaconcept, fig.cap='Specifying a Concept Set - Step 1',echo=FALSE}
...
```{r ATLASfindyourconcept, fig.cap='Specifying a Concept Set - Step 2',echo=FALSE}
...
```{r ATLASfirstexposure, fig.cap='Adding Attribute to Initial Criteria - Step 1',echo=FALSE}
...
```{r ATLASfirsttimeever, fig.cap='Adding Attribute to Initial Criteria - Step 2',echo=FALSE}
...
```{r ATLASlookback, fig.cap='Adjusting the Observation Period',echo=FALSE}
...
```{r EarliestEventExplained, fig.cap='Patient Eligibility by Criteria Applied',echo=FALSE}
...
```{r ATLAS-IC1, fig.cap='Additional Inclusion Criteria #1',echo=FALSE}
...
```{r ATLAS-IC2, fig.cap='Additional Inclusion Criteria #2',echo=FALSE}
...
```{r ATLAS-IC3, fig.cap='Additional Inclusion Criteria #3',echo=FALSE}
...
```{r ATLAS-cohortexit, fig.cap='Cohort Exit Criteria',echo=FALSE}
