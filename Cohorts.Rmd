...
```{r CohortPractice, fig.cap='Logical Diagram of Intended Cohort',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r aceinhibitors, fig.cap='Searching the Vocabulary - ACE Inhibitors',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r aceConceptSetExpression, fig.cap='Importing a Concept Set from ATLAS Repository',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r ATLASfindyourconcept, fig.cap='Importing a Concept Set from ATLAS Repository',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r ATLASIC1, fig.cap='Additional Inclusion criteria 1',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r ATLASIC2, fig.cap='Additional Inclusion Criteria 2',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r ATLASIC3, fig.cap='Additional Inclusion Criteria 3',echo=FALSE, out.width='100%', fig.align='center'}
