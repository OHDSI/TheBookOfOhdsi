...
```{r ATLASinitialevent, fig.cap='Adding an Initial Event',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r ATLASdrugexposure, fig.cap='Defining a Drug Exposure',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r EarliestEventExplained, fig.cap='Explaining Patient Eligibility by Criteria Applied',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r addtldescription, fig.cap='ria 1',echo=FALSE, out.width='90%', fig.align='center'}
knitr::include_graphics("images/Cohorts/additional-description.png")
```
...
```{r ATLAScohortexit, fig.cap='Cohort Exit Criteria',echo=FALSE, out.width='100%', fig.align='center'}
