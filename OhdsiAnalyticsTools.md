...
The Methods Library has already been used in many published clinical studies (refs), as well as methodological studies (refs). Great care is taken to ensure the validity of the Methods Library, as described in Chapter \@ref(SoftwareValidity).
