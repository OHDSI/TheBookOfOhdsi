...
### Documentation 
Documentation for ATLAS can be found online in the [ATLAS Github repository wiki](https://github.com/OHDSI/ATLAS/wiki).  This wiki includes information on the various application features as well as links to online video tutorials.  
...
Amazon has prepared two environments that can be instantiated in the AWS cloud computing environment with a click of the button: OHDSI-in-a-Box[^ohdsiInaBoxUrl] and OHDSIonAWS[^ohdsiOnAwsUrl]. 
