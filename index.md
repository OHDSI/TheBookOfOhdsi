...
<img src="images/Cover/Cover.png" width="250" height="375" alt="Cover image" align="right" style="margin: 0 1em 0 1em" /> This is a book about Observational Health Data Sciences and Informatics (OHDSI). It was written by the OHSDI community to serve as a central knowledge repository, and it is still is being written: The Book of OHDSI is a living document, maintained through open source development tools. The online version is continuously updated and available for free at [http://book.ohdsi.org](http://book.ohdsi.org). A physical copy of the book is available from Amazon at cost price.
