...
When ETL is completed or updated, maintaining relevant metadata about the data facilitates later analytical use. For example THEMIS group proposed documenting how many persons were deleted from the source data due to missing birth year.
