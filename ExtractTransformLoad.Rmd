...
```{r WhiteRabbitLocation, fig.cap='The "Pick Folder" button allows the specification of a working folder for the WhiteRabbit application',echo=FALSE, out.width='100%'}
...
```{r WhiteRabbitAddTables, echo=FALSE, out.width='100%'}
...
```{r WhiteRabbitScanSettings, fig.cap='WhiteRabbit scan settings', echo=FALSE, out.width='100%'}
knitr::include_graphics("images/ExtractTransformLoad/WhiteRabbitScanSettings.png")
```
...
```{r ScanConditionsTab, fig.cap="Example tab from a scan report", echo=FALSE, out.width='100%'}
knitr::include_graphics("images/ExtractTransformLoad/ScanConditionsTab.png")
```
