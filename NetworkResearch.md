...
\begin{figure}
\includegraphics[width=1\linewidth]{images/NetworkStudies/ARACHNE} \caption{The ARACHNE Network Study Process.}(\#fig:figure1)
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/NetworkStudies/ARACHNENoN} \caption{The ARACHNE Network of Networks.}(\#fig:figure2)
\end{figure}
